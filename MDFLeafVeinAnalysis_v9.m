...
%G_veins.Nodes.node_OD0(abs(G_veins.Nodes.node_OD0)>180) = mod(G_veins.Nodes.node_OD0(abs(G_veins.Nodes.node_OD0)>180),180);
...
T = fnc_summary(T,G_veins.Nodes.node_D2,'N','BD2','none',1);
T = fnc_summary(T,G_veins.Nodes.node_D1,'N','BD1','none',1);
T = fnc_summary(T,G_veins.Nodes.node_D0,'N','BD0','none',1);
% T = fnc_summary(T,G_veins.Nodes.node_D2_D1,'N','Rnd','none',1);
% T = fnc_summary(T,G_veins.Nodes.node_D2_D0,'N','Rnx','none',1);
% T = fnc_summary(T,G_veins.Nodes.node_D1_D0,'N','Rdx','none',1);
T = fnc_summary(T,G_veins.Nodes.theta_D2_D1,'N','A21','circ',1);
T = fnc_summary(T,G_veins.Nodes.theta_D2_D0,'N','A20','circ',1);
T = fnc_summary(T,G_veins.Nodes.theta_D1_D0,'N','A10','circ',1);
end
